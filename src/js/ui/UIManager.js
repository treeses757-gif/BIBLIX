// ========== FILE: src/js/main.js (исправленный, с initStarfield) ==========
...
// Анонимный вход для Realtime Database
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  await authManager.anonymousLoginPromise; // ждём анонимный вход (если есть в AuthManager)
